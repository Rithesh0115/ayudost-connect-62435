...
const mockDoctors = [
  ...
  },
  {
    id: 9,
    name: "Dr. Kavya Rao",
    qualification: "BAMS, MD (Kaumarabhritya)",
    specialization: "Child Development & Immunity",
    experience: "7 years",
    rating: 4.7,
    reviews: 76,
  ...
  },
  {
    ...
    specialization: "Preventive Medicine & Lifestyle Management",
    experience: "16 years",
    rating: 4.9,
    reviews: 201,
    languages: ["English", "Hindi", "Kannada"],
  ...
  },
  {
    ...
    qualification: "BAMS, MD (Roga Nidana)",
    specialization: "Diagnosis & Chronic Disease Management",
    experience: "13 years",
    rating: 4.8,
    reviews: 167,
    languages: ["English", "Kannada", "Tulu"],
  ...
  },
  {
    ...
    qualification: "BAMS, MD (Agada Tantra)",
    specialization: "Toxicology & Emergency Care",
    experience: "10 years",
    rating: 4.6,
    reviews: 89,
  ...
  },
  {
    id: 13,
    name: "Dr. Pooja Menon",
    qualification: "BAMS, MD (Panchkarma)",
    specialization: "Detoxification & Body Cleansing",
    experience: "12 years",
    rating: 4.9,
    reviews: 195,
